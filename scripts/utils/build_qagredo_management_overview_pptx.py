#!/usr/bin/env python3
"""One-slide management summary PPTX for QAGRedo."""
...
def build(output: Path) -> None:
    ...
    tp.text = "QAGRedo — management view (simplified)"
    tp.font.size = Pt(28)
    tp.font.bold = True
    ...
    for line, sz in [
        ...
        (
            "• Detail: see QAGRedo_Software_Engineering_Diagrams.html "
            "in /docs.",
            12,
        ),
    ]:
    ...
    fp.text = (
        "Regenerate: "
        "python3 scripts/utils/build_qagredo_management_overview_pptx.py"
    )
    fp.font.size = Pt(10)
...
def main() -> None:
    ...
    d = root / "docs" / "QAGRedo_Management_Overview.pptx"
