...
OUTFILE = DOCS_DIR / "QAG_Executive_Overview_Tradeoffs.pptx"

IMG = {
    "pipeline": DOCS_DIR / "qag_full_pipeline_flow_16x9.png",
    "input": DOCS_DIR / "qag_input_prep_explained_16x9.png",
    "langgraph": DOCS_DIR / "qag_langchain_detail_16x9.png",
    "langchain_q_lane": DOCS_DIR / "qag_langchain_question_lane_16x9.png",
    "langchain_a_lane": DOCS_DIR / "qag_langchain_answer_lane_16x9.png",
    "langgraph_detailed": DOCS_DIR / "qag_langgraph_pipeline_detailed.png",
    "answer_detailed": DOCS_DIR / "qag_answer_generator_detailed.png",
...
def build():
    ...
    # 2. What is QAG
    s = prs.slides.add_slide(blank)
    add_title(s, "1. What QAG Does", "Offline document QA with grounding verification")
    add_bullets(
        s,
        [
    ...
    add_takeaway(s, "QAG is an auditable QA evaluation pipeline, not just a single prompt call.")
    ...
    add_source_ref(s, "docs/qag_langchain_question_lane.dot")
    ...
    add_source_ref(s, "docs/qag_langchain_answer_lane.dot")
    ...
    add_bullets(
        ...
        [
            ...
            "QAG needs both because quality failures can occur at single-call level and at workflow-routing level.",
        ],
        x=0.9,
        y=5.9,
        w=11.7,
    ...
    add_source_ref(s, "docs/qag_langgraph_pipeline_detailed.dot")
    ...
    add_source_ref(s, "docs/qag_answer_generator_detailed.dot")
    ...
    # 9. Value proposition
    s = prs.slides.add_slide(blank)
    add_title(s, "8. Business Value", "Why teams adopt QAG")
    add_bullets(
        s,
        [
    ...
    add_takeaway(s, "QAG is strongest when quality and auditability matter more than raw speed.")
    ...
    add_takeaway(s, "Position QAG as a quality-first pipeline, not a generic chatbot replacement.")
    ...
    # 15. Closing
    s = prs.slides.add_slide(blank)
    add_title(s, "14. Final Recommendation", "Use QAG when trustworthiness is a first-class requirement")
    add_bullets(
        s,
        [
            "Adopt QAG for quality-critical, auditable document QA workflows.",
    ...
    p.text = "Message for leadership: QAG is a quality-governance system with explicit trade-offs, not a black-box generator."
    p.font.size = Pt(14)
    p.font.bold = True
